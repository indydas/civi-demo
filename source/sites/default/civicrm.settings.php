...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:root@localhost/civi_demo?new_link=true');
}
...
$civicrm_root = '/Applications/MAMP/htdocs/civi-site/sites/all/modules/contrib/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/Applications/MAMP/htdocs/civi-site/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://localhost:8888/civi-site/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '52f887035183d28ce4b58179c8eab84b');
}
...
// define( 'CIVICRM_MAIL_LOG', '/Applications/MAMP/htdocs/civi-site/sites/default/files/civicrm/templates_c//mail.log');
// }
